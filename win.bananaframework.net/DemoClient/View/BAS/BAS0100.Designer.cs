namespace DemoClient.View.BAS
{
	partial class BAS0100
	{
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(BAS0100));
			this.groupBox3 = new System.Windows.Forms.GroupBox();
			this.gridView1 = new DemoClient.Controls.GridView();
			this.COMPANY_CD = new System.Windows.Forms.DataGridViewTextBoxColumn();
			this.COMPANY_NM = new System.Windows.Forms.DataGridViewTextBoxColumn();
			...
			this.BI_BUBIN_NO = new System.Windows.Forms.DataGridViewTextBoxColumn();
			this.BI_ZIP_NO = new System.Windows.Forms.DataGridViewTextBoxColumn();
			this.BI_ADDR_BSC = new System.Windows.Forms.DataGridViewTextBoxColumn();
			this.BI_UPTE = new System.Windows.Forms.DataGridViewTextBoxColumn();
			this.BI_JONGMOK = new System.Windows.Forms.DataGridViewTextBoxColumn();
			this.BI_EMAIL = new System.Windows.Forms.DataGridViewTextBoxColumn();
			...
			this._txtCOMPANY_CD = new BANANA.Windows.Controls.TextBox();
			...
			this._txtCOMPANY_NM_S = new BANANA.Windows.Controls.TextBox();
			this.lblUSR_NM_S = new BANANA.Windows.Controls.Label();
			this._txtCOMPANY_CD_S = new BANANA.Windows.Controls.TextBox();
			...
			this.groupBox3.Size = new System.Drawing.Size(644, 578);
			...
			this.gridView1.Size = new System.Drawing.Size(638, 554);
			this.gridView1.TabIndex = 0;
			this.gridView1.ShowHeaderCheckBox = false;
			this.gridView1.CellClick += new System.Windows.Forms.DataGridViewCellEventHandler(this.grvBAS0100_CellClick);
			this.gridView1.CellDoubleClick += new System.Windows.Forms.DataGridViewCellEventHandler(this.grvBAS0100_CellDoubleClick);
			// 
			// COMPANY_CD
			// 
			this.COMPANY_CD.DataPropertyName = "COMPANY_CD";
			this.COMPANY_CD.HeaderText = "회사코드";
			this.COMPANY_CD.Name = "COMPANY_CD";
			this.COMPANY_CD.ReadOnly = true;
			this.COMPANY_CD.Width = 94;
			// 
			// COMPANY_NM
			// 
			this.COMPANY_NM.DataPropertyName = "COMPANY_NM";
			this.COMPANY_NM.HeaderText = "회사명";
			this.COMPANY_NM.Name = "COMPANY_NM";
			this.COMPANY_NM.ReadOnly = true;
			this.COMPANY_NM.Width = 80;
			// 
			// PRSNT_NM
			// 
			...
			// BAND01
			// 
			this.BAND01.HeaderText = "사업자등록정보";
			this.BAND01.Name = "BAND01";
			this.BAND01.ReadOnly = true;
			this.BAND01.TargetColumnss.Add("BI_COMPANY_NM");
			this.BAND01.TargetColumnss.Add("BI_PRSNT_NM");
			this.BAND01.TargetColumnss.Add("BI_SAUP_NO");
			this.BAND01.TargetColumnss.Add("BI_BUBIN_NO");
			this.BAND01.TargetColumnss.Add("BI_ZIP_NO");
			this.BAND01.TargetColumnss.Add("BI_ADDR_BSC");
			this.BAND01.TargetColumnss.Add("BI_UPTE");
			this.BAND01.TargetColumnss.Add("BI_JONGMOK");
			this.BAND01.TargetColumnss.Add("BI_EMAIL");
			this.BAND01.Width = 113;
			// 
			// BI_COMPANY_NM
			// 
			...
			// BI_BUBIN_NO
			// 
			this.BI_BUBIN_NO.DataPropertyName = "BI_BUBIN_NO";
			this.BI_BUBIN_NO.HeaderText = "법인등록번호";
			this.BI_BUBIN_NO.Name = "BI_BUBIN_NO";
			this.BI_BUBIN_NO.ReadOnly = true;
			this.BI_BUBIN_NO.Width = 122;
			// 
			// BI_ZIP_NO
			// 
			this.BI_ZIP_NO.DataPropertyName = "BI_ZIP_NO";
			this.BI_ZIP_NO.HeaderText = "우편번호";
			this.BI_ZIP_NO.Name = "BI_ZIP_NO";
			this.BI_ZIP_NO.ReadOnly = true;
			this.BI_ZIP_NO.Width = 94;
			// 
			// BI_ADDR_BSC
			// 
			this.BI_ADDR_BSC.DataPropertyName = "BI_ADDR_BSC";
			this.BI_ADDR_BSC.HeaderText = "기본주소";
			this.BI_ADDR_BSC.Name = "BI_ADDR_BSC";
			this.BI_ADDR_BSC.ReadOnly = true;
			this.BI_ADDR_BSC.Width = 94;
			// 
			// BI_UPTE
			// 
			this.BI_UPTE.DataPropertyName = "BI_UPTE";
			this.BI_UPTE.HeaderText = "업태";
			this.BI_UPTE.Name = "BI_UPTE";
			this.BI_UPTE.ReadOnly = true;
			this.BI_UPTE.Width = 66;
			// 
			// BI_JONGMOK
			// 
			this.BI_JONGMOK.DataPropertyName = "BI_JONGMOK";
			this.BI_JONGMOK.HeaderText = "종목";
			this.BI_JONGMOK.Name = "BI_JONGMOK";
			this.BI_JONGMOK.ReadOnly = true;
			this.BI_JONGMOK.Width = 66;
			// 
			// BI_EMAIL
			// 
			this.BI_EMAIL.DataPropertyName = "BI_EMAIL";
			this.BI_EMAIL.HeaderText = "세금계산서 이메일";
			this.BI_EMAIL.Name = "BI_EMAIL";
			this.BI_EMAIL.ReadOnly = true;
			this.BI_EMAIL.Width = 155;
			// 
			// SYSREGDATE
			// 
			...
			this.collapsibleSplitter1.Location = new System.Drawing.Point(644, 76);
			...
			this.tabControl1.Size = new System.Drawing.Size(707, 578);
			this.tabControl1.TabIndex = 4;
			this.tabControl1.SelectedIndexChanged += new System.EventHandler(this.tabControl1_SelectedIndexChanged);
			// 
			// tabPage1
			// 
			this.tabPage1.Controls.Add(this._btnSave);
			this.tabPage1.Controls.Add(this._btnDel);
			this.tabPage1.Controls.Add(this._btnAdd);
			this.tabPage1.Controls.Add(this.tableLayoutPanel1);
			this.tabPage1.Location = new System.Drawing.Point(4, 25);
			this.tabPage1.Name = "tabPage1";
			this.tabPage1.Padding = new System.Windows.Forms.Padding(3);
			this.tabPage1.Size = new System.Drawing.Size(699, 549);
			...
			this._btnSave.Location = new System.Drawing.Point(530, 229);
			this._btnSave.Name = "_btnSave";
			this._btnSave.Size = new System.Drawing.Size(75, 27);
			this._btnSave.TabIndex = 1100;
			...
			this._btnDel.ButtonImage = DemoClient.Controls.ButtonImage.Delete;
			...
			this._btnDel.Location = new System.Drawing.Point(611, 229);
			this._btnDel.Name = "_btnDel";
			this._btnDel.Size = new System.Drawing.Size(75, 27);
			this._btnDel.TabIndex = 1110;
			...
			// _btnAdd
			// 
			this._btnAdd.ButtonImage = DemoClient.Controls.ButtonImage.Add;
			...
			this._btnAdd.Location = new System.Drawing.Point(449, 229);
			this._btnAdd.Name = "_btnAdd";
			this._btnAdd.Size = new System.Drawing.Size(75, 27);
			this._btnAdd.TabIndex = 1090;
			...
			this.tableLayoutPanel1.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Absolute, 90F));
			this.tableLayoutPanel1.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Absolute, 140F));
			this.tableLayoutPanel1.Controls.Add(this._chkPAY_DAY, 5, 2);
			...
			this.tableLayoutPanel1.Controls.Add(this._txtCOMPANY_NM, 3, 0);
			...
			this.tableLayoutPanel1.Controls.Add(this._txtCOMPANY_CD, 1, 0);
			...
			this.tableLayoutPanel1.Size = new System.Drawing.Size(693, 220);
			this.tableLayoutPanel1.TabIndex = 0;
			// 
			// _chkPAY_DAY
			// 
			this._chkPAY_DAY.Anchor = System.Windows.Forms.AnchorStyles.Left;
			this._chkPAY_DAY.AutoSize = true;
			this._chkPAY_DAY.Location = new System.Drawing.Point(553, 58);
			this._chkPAY_DAY.Name = "_chkPAY_DAY";
			this._chkPAY_DAY.Size = new System.Drawing.Size(104, 19);
			this._chkPAY_DAY.TabIndex = 1075;
			this._chkPAY_DAY.Text = "토요일출금";
			this._chkPAY_DAY.UseVisualStyleBackColor = true;
			// 
			// labelmemo
			// 
			...
			// _txtCOMPANY_NM
			// 
			this._txtCOMPANY_NM.Anchor = System.Windows.Forms.AnchorStyles.Left;
			this._txtCOMPANY_NM.Compulsory = true;
			this._txtCOMPANY_NM.DelegateProperty = true;
			this._txtCOMPANY_NM.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F);
			this._txtCOMPANY_NM.Location = new System.Drawing.Point(323, 3);
			this._txtCOMPANY_NM.Name = "_txtCOMPANY_NM";
			this._txtCOMPANY_NM.ReadOnly = true;
			this._txtCOMPANY_NM.Size = new System.Drawing.Size(130, 23);
			this._txtCOMPANY_NM.TabIndex = 1010;
			this._txtCOMPANY_NM.ValidationGroup = "A";
			this._txtCOMPANY_NM.WaterMarkColor = System.Drawing.Color.Silver;
			this._txtCOMPANY_NM.WaterMarkText = "";
			// 
			// lblCOMPANY_CD
			// 
			...
			// _txtCOMPANY_CD
			// 
			this._txtCOMPANY_CD.Anchor = System.Windows.Forms.AnchorStyles.Left;
			this._txtCOMPANY_CD.DelegateProperty = true;
			this._txtCOMPANY_CD.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F);
			this._txtCOMPANY_CD.Location = new System.Drawing.Point(93, 3);
			this._txtCOMPANY_CD.Name = "_txtCOMPANY_CD";
			this._txtCOMPANY_CD.ReadOnly = true;
			this._txtCOMPANY_CD.Size = new System.Drawing.Size(130, 23);
			this._txtCOMPANY_CD.TabIndex = 1000;
			this._txtCOMPANY_CD.ValidationGroup = null;
			this._txtCOMPANY_CD.WaterMarkColor = System.Drawing.Color.Silver;
			this._txtCOMPANY_CD.WaterMarkText = "";
			// 
			// _txtMEMO
			// 
			...
			// tabPage2
			// 
			this.tabPage2.Controls.Add(this._btnSave2);
			this.tabPage2.Controls.Add(this.tableLayoutPanel2);
			this.tabPage2.Location = new System.Drawing.Point(4, 25);
			this.tabPage2.Name = "tabPage2";
			this.tabPage2.Padding = new System.Windows.Forms.Padding(3);
			this.tabPage2.Size = new System.Drawing.Size(699, 549);
			...
			// _btnSave2
			// 
			this._btnSave2.ButtonConfirm = true;
			this._btnSave2.ButtonImage = DemoClient.Controls.ButtonImage.Save;
			...
			this._btnSave2.Location = new System.Drawing.Point(621, 117);
			this._btnSave2.Name = "_btnSave2";
			this._btnSave2.Size = new System.Drawing.Size(75, 27);
			this._btnSave2.TabIndex = 1230;
			...
			this._btnSave2.Click += new System.EventHandler(this._btnSave_Click);
			// 
			// tableLayoutPanel2
			// 
			...
			this._txtBI_ADDR_BSC.TabIndex = 1180;
			...
			this.label10.Location = new System.Drawing.Point(245, 27);
			...
			this._txtBI_JONGMOK.TabIndex = 1210;
			...
			this._txtBI_ADDR_DTL.TabIndex = 1190;
			...
			this.label15.Location = new System.Drawing.Point(290, 87);
			...
			this._txtBI_EMAIL.TabIndex = 1220;
			...
			this._txtBI_ZIP_NO.TabIndex = 1170;
			...
			this._txtBI_UPTE.TabIndex = 1200;
			...
			this.tableLayoutPanel3.Controls.Add(this._txtCOMPANY_NM_S, 1, 0);
			this.tableLayoutPanel3.Controls.Add(this.lblUSR_NM_S, 0, 0);
			this.tableLayoutPanel3.Controls.Add(this._txtCOMPANY_CD_S, 3, 0);
			this.tableLayoutPanel3.Controls.Add(this.lblUSR_ID_S, 2, 0);
			this.tableLayoutPanel3.Controls.Add(this._txtPRSNT_NM_S, 5, 0);
			this.tableLayoutPanel3.Controls.Add(this.label18, 0, 1);
			this.tableLayoutPanel3.Controls.Add(this._txtADDR_BSC_S, 1, 1);
			this.tableLayoutPanel3.Controls.Add(this.label19, 2, 1);
			this.tableLayoutPanel3.Controls.Add(this._cmbBI_BINF_CD_S, 3, 1);
			this.tableLayoutPanel3.Controls.Add(this.label20, 4, 1);
			this.tableLayoutPanel3.Controls.Add(this._txtBI_SAUP_NO_S, 5, 1);
			...
			this.tableLayoutPanel3.RowStyles.Add(new System.Windows.Forms.RowStyle(System.Windows.Forms.SizeType.Absolute, 27F));
			this.tableLayoutPanel3.Size = new System.Drawing.Size(1348, 52);
			this.tableLayoutPanel3.TabIndex = 1;
			// 
			// _txtCOMPANY_NM_S
			// 
			this._txtCOMPANY_NM_S.Anchor = System.Windows.Forms.AnchorStyles.Left;
			this._txtCOMPANY_NM_S.AutoTab = false;
			this._txtCOMPANY_NM_S.DelegateProperty = true;
			this._txtCOMPANY_NM_S.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F);
			this._txtCOMPANY_NM_S.Location = new System.Drawing.Point(95, 4);
			this._txtCOMPANY_NM_S.Name = "_txtCOMPANY_NM_S";
			this._txtCOMPANY_NM_S.Size = new System.Drawing.Size(130, 23);
			this._txtCOMPANY_NM_S.TabIndex = 100;
			this._txtCOMPANY_NM_S.ValidationGroup = null;
			this._txtCOMPANY_NM_S.WaterMarkColor = System.Drawing.Color.Empty;
			this._txtCOMPANY_NM_S.WaterMarkText = "";
			this._txtCOMPANY_NM_S.KeyDown += new System.Windows.Forms.KeyEventHandler(this.txtUSR_NM_S_KeyDown);
			// 
			// lblUSR_NM_S
			// 
			this.lblUSR_NM_S.Anchor = System.Windows.Forms.AnchorStyles.Right;
			this.lblUSR_NM_S.AutoSize = true;
			this.lblUSR_NM_S.Location = new System.Drawing.Point(36, 7);
			this.lblUSR_NM_S.Name = "lblUSR_NM_S";
			this.lblUSR_NM_S.Size = new System.Drawing.Size(52, 15);
			this.lblUSR_NM_S.TabIndex = 9;
			this.lblUSR_NM_S.Text = "회사명";
			// 
			// _txtCOMPANY_CD_S
			// 
			this._txtCOMPANY_CD_S.Anchor = System.Windows.Forms.AnchorStyles.Left;
			this._txtCOMPANY_CD_S.AutoTab = false;
			this._txtCOMPANY_CD_S.DelegateProperty = true;
			this._txtCOMPANY_CD_S.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F);
			this._txtCOMPANY_CD_S.Location = new System.Drawing.Point(327, 4);
			this._txtCOMPANY_CD_S.Name = "_txtCOMPANY_CD_S";
			this._txtCOMPANY_CD_S.Size = new System.Drawing.Size(130, 23);
			this._txtCOMPANY_CD_S.TabIndex = 110;
			this._txtCOMPANY_CD_S.ValidationGroup = null;
			this._txtCOMPANY_CD_S.WaterMarkColor = System.Drawing.Color.Empty;
			this._txtCOMPANY_CD_S.WaterMarkText = "";
			this._txtCOMPANY_CD_S.KeyDown += new System.Windows.Forms.KeyEventHandler(this.txtUSR_NM_S_KeyDown);
			// 
			// lblUSR_ID_S
			// 
			this.lblUSR_ID_S.Anchor = System.Windows.Forms.AnchorStyles.Right;
			this.lblUSR_ID_S.AutoSize = true;
			this.lblUSR_ID_S.Location = new System.Drawing.Point(253, 7);
			this.lblUSR_ID_S.Name = "lblUSR_ID_S";
			this.lblUSR_ID_S.Size = new System.Drawing.Size(67, 15);
			this.lblUSR_ID_S.TabIndex = 7;
			this.lblUSR_ID_S.Text = "회사코드";
			// 
			// _txtPRSNT_NM_S
			// 
			...
			this._txtPRSNT_NM_S.Location = new System.Drawing.Point(569, 4);
			this._txtPRSNT_NM_S.Name = "_txtPRSNT_NM_S";
			this._txtPRSNT_NM_S.Size = new System.Drawing.Size(130, 23);
			this._txtPRSNT_NM_S.TabIndex = 120;
			this._txtPRSNT_NM_S.ValidationGroup = null;
			this._txtPRSNT_NM_S.WaterMarkColor = System.Drawing.Color.Empty;
			this._txtPRSNT_NM_S.WaterMarkText = "";
			this._txtPRSNT_NM_S.KeyDown += new System.Windows.Forms.KeyEventHandler(this.txtUSR_NM_S_KeyDown);
			// 
			// label18
			// 
			...
			this._txtADDR_BSC_S.Size = new System.Drawing.Size(130, 23);
			this._txtADDR_BSC_S.TabIndex = 130;
			this._txtADDR_BSC_S.ValidationGroup = null;
			this._txtADDR_BSC_S.WaterMarkColor = System.Drawing.Color.Empty;
			this._txtADDR_BSC_S.WaterMarkText = "";
			this._txtADDR_BSC_S.KeyDown += new System.Windows.Forms.KeyEventHandler(this.txtUSR_NM_S_KeyDown);
			// 
			// label19
			// 
			this.label19.Anchor = System.Windows.Forms.AnchorStyles.Right;
			this.label19.AutoSize = true;
			this.label19.Location = new System.Drawing.Point(238, 35);
			this.label19.Name = "label19";
			this.label19.Size = new System.Drawing.Size(82, 15);
			this.label19.TabIndex = 305;
			this.label19.Text = "사업자구분";
			// 
			// _cmbBI_BINF_CD_S
			// 
			this._cmbBI_BINF_CD_S.Anchor = System.Windows.Forms.AnchorStyles.Left;
			this._cmbBI_BINF_CD_S.DataSource = null;
			this._cmbBI_BINF_CD_S.DelegateProperty = true;
			this._cmbBI_BINF_CD_S.Location = new System.Drawing.Point(327, 32);
			...
			this._cmbBI_BINF_CD_S.Size = new System.Drawing.Size(130, 21);
			this._cmbBI_BINF_CD_S.TabIndex = 140;
			this._cmbBI_BINF_CD_S.ValidationGroup = null;
			this._cmbBI_BINF_CD_S.DropDownClosed += new System.EventHandler(this._cmbBI_BINF_CD_S_DropDownClosed);
			// 
			// label20
			// 
			this.label20.Anchor = System.Windows.Forms.AnchorStyles.Right;
			this.label20.AutoSize = true;
			this.label20.Location = new System.Drawing.Point(480, 29);
			this.label20.Name = "label20";
			this.label20.Size = new System.Drawing.Size(82, 27);
			this.label20.TabIndex = 322;
			this.label20.Text = "사업자등록번호";
			// 
			// _txtBI_SAUP_NO_S
			// 
			this._txtBI_SAUP_NO_S.Anchor = System.Windows.Forms.AnchorStyles.Left;
			this._txtBI_SAUP_NO_S.AutoTab = false;
			this._txtBI_SAUP_NO_S.DelegateProperty = true;
			this._txtBI_SAUP_NO_S.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F);
			this._txtBI_SAUP_NO_S.ImeMode = BANANA.Windows.Controls.ImeMode.DashNumeric;
			this._txtBI_SAUP_NO_S.Location = new System.Drawing.Point(569, 32);
			this._txtBI_SAUP_NO_S.Name = "_txtBI_SAUP_NO_S";
			this._txtBI_SAUP_NO_S.Size = new System.Drawing.Size(130, 23);
			this._txtBI_SAUP_NO_S.TabIndex = 150;
			this._txtBI_SAUP_NO_S.TextAlign = System.Windows.Forms.HorizontalAlignment.Right;
			this._txtBI_SAUP_NO_S.ValidationGroup = null;
			this._txtBI_SAUP_NO_S.WaterMarkColor = System.Drawing.Color.Empty;
			this._txtBI_SAUP_NO_S.WaterMarkText = "";
			this._txtBI_SAUP_NO_S.KeyDown += new System.Windows.Forms.KeyEventHandler(this.txtUSR_NM_S_KeyDown);
			// 
			// label16
			// 
			this.label16.Anchor = System.Windows.Forms.AnchorStyles.Right;
			this.label16.AutoSize = true;
			this.label16.Location = new System.Drawing.Point(495, 7);
			this.label16.Name = "label16";
			this.label16.Size = new System.Drawing.Size(67, 15);
			this.label16.TabIndex = 301;
			this.label16.Text = "대표자명";
			// 
			// flowLayoutPanel1
			// 
			...
			this.Name = "BAS0100";
			this.Text = "운영회사정보관리:BAS0100";
			this.Load += new System.EventHandler(this.BAS0100_Load);
			this.Shown += new System.EventHandler(this.BAS0100_Shown);
		...
		private BANANA.Windows.Controls.TextBox _txtCOMPANY_NM;
		private System.Windows.Forms.Label label1;
		private System.Windows.Forms.Label label2;
		private BANANA.Windows.Controls.TextBox _txtCOMPANY_CD;
		...
		private BANANA.Windows.Controls.TextBox _txtCOMPANY_NM_S;
		private BANANA.Windows.Controls.TextBox _txtCOMPANY_CD_S;
		...
		private BANANA.Windows.Controls.CheckBox _chkPAY_DAY;
		private System.Windows.Forms.DataGridViewTextBoxColumn COMPANY_CD;
		private System.Windows.Forms.DataGridViewTextBoxColumn COMPANY_NM;
		...
		private System.Windows.Forms.DataGridViewTextBoxColumn BI_BUBIN_NO;
		private System.Windows.Forms.DataGridViewTextBoxColumn BI_ZIP_NO;
		private System.Windows.Forms.DataGridViewTextBoxColumn BI_ADDR_BSC;
		private System.Windows.Forms.DataGridViewTextBoxColumn BI_UPTE;
		private System.Windows.Forms.DataGridViewTextBoxColumn BI_JONGMOK;
		private System.Windows.Forms.DataGridViewTextBoxColumn BI_EMAIL;
