...
{
	partial class HLP0100 : Controllers.BasePopupForm
	{
		public HLP0100()
		{
			InitializeComponent();
		...
		private void HLP100_Load(object sender, EventArgs e)
		{
			...
			// CID 찍어주기
			this.textBoxDescription.Text	+= string.Format("\r\n\r\n==============================\r\n컴퓨터명: {0}", base.GetComputerName());
			this.textBoxDescription.Text	+= string.Format("\r\n컴퓨터ID: {0}", base.GetComputerID());
		}
	}
}
