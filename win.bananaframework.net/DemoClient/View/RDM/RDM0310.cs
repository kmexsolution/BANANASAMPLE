...
{
    public partial class RDM0310 : DemoClient.Controllers.BaseForm
    {
        // 검색 쓰레드
        private Thread _thread;

        #region RDM0310 : 생성자 함수
        ...
        #region RDM0310_Load : 폼 로드 이벤트

        private void RDM0310_Load(object sender, EventArgs e)
        {
            try
            {
        ...
        int Search()
        {
            ...
            try
            {
                DataTable _dt = base.GetDataTable("PCSP_RDM0310_R1"
        ...
        private void gridView1_DataBindingComplete(object sender, DataGridViewBindingCompleteEventArgs e)
        {
            ...
            {
                row.Cells["STR_CD"].Style = new DataGridViewCellStyle() { ForeColor = Color.Red };
            }
