namespace DemoClient.View.WDR
{
	partial class WDR0600
	{
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(WDR0600));
			...
			this._txtTotalCnt = new BANANA.Windows.Controls.TextBox();
			this._txtTotalAmt = new BANANA.Windows.Controls.TextBox();
			this.label10 = new BANANA.Windows.Controls.Label();
			this.label9 = new BANANA.Windows.Controls.Label();
			this._txtCnclCnt = new BANANA.Windows.Controls.TextBox();
			...
			this._txtApprCnt = new BANANA.Windows.Controls.TextBox();
			...
			this.groupBox3.Size = new System.Drawing.Size(1354, 579);
			...
			this.gridView1.Size = new System.Drawing.Size(1348, 555);
			this.gridView1.TabIndex = 4;
			this.gridView1.DataBindingComplete += new System.Windows.Forms.DataGridViewBindingCompleteEventHandler(this.gridView1_DataBindingComplete_1);
			// 
			// IDX
			// 
			...
			// groupBox2
			// 
			this.groupBox2.Controls.Add(this._txtTotalCnt);
			this.groupBox2.Controls.Add(this._txtTotalAmt);
			this.groupBox2.Controls.Add(this.label10);
			this.groupBox2.Controls.Add(this.label9);
			this.groupBox2.Controls.Add(this._txtCnclCnt);
			this.groupBox2.Controls.Add(this._txtCnclAmt);
			this.groupBox2.Controls.Add(this.label8);
			this.groupBox2.Controls.Add(this.label7);
			this.groupBox2.Controls.Add(this._txtApprCnt);
			this.groupBox2.Controls.Add(this._txtApprAmt);
			this.groupBox2.Controls.Add(this.label6);
			this.groupBox2.Dock = System.Windows.Forms.DockStyle.Bottom;
			this.groupBox2.Location = new System.Drawing.Point(0, 683);
			this.groupBox2.Name = "groupBox2";
			this.groupBox2.Size = new System.Drawing.Size(1354, 50);
			...
			// _txtTotalCnt
			// 
			this._txtTotalCnt.DelegateProperty = true;
			this._txtTotalCnt.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F);
			this._txtTotalCnt.Location = new System.Drawing.Point(602, 17);
			this._txtTotalCnt.Name = "_txtTotalCnt";
			this._txtTotalCnt.ReadOnly = true;
			this._txtTotalCnt.Size = new System.Drawing.Size(67, 23);
			this._txtTotalCnt.TabIndex = 10;
			this._txtTotalCnt.TabStop = false;
			this._txtTotalCnt.TextAlign = System.Windows.Forms.HorizontalAlignment.Right;
			this._txtTotalCnt.ValidationGroup = null;
			this._txtTotalCnt.WaterMarkColor = System.Drawing.Color.Empty;
			this._txtTotalCnt.WaterMarkText = "";
			// 
			// _txtTotalAmt
			// 
			this._txtTotalAmt.DelegateProperty = true;
			this._txtTotalAmt.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F);
			this._txtTotalAmt.ImeMode = BANANA.Windows.Controls.ImeMode.Integer;
			this._txtTotalAmt.Location = new System.Drawing.Point(501, 17);
			this._txtTotalAmt.Name = "_txtTotalAmt";
			this._txtTotalAmt.ReadOnly = true;
			this._txtTotalAmt.Size = new System.Drawing.Size(100, 23);
			this._txtTotalAmt.TabIndex = 9;
			this._txtTotalAmt.TabStop = false;
			this._txtTotalAmt.TextAlign = System.Windows.Forms.HorizontalAlignment.Right;
			this._txtTotalAmt.ValidationGroup = null;
			this._txtTotalAmt.WaterMarkColor = System.Drawing.Color.Empty;
			this._txtTotalAmt.WaterMarkText = "";
			// 
			// label10
			// 
			...
			// _txtCnclCnt
			// 
			this._txtCnclCnt.DelegateProperty = true;
			this._txtCnclCnt.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F);
			this._txtCnclCnt.Location = new System.Drawing.Point(374, 17);
			this._txtCnclCnt.Name = "_txtCnclCnt";
			this._txtCnclCnt.ReadOnly = true;
			this._txtCnclCnt.Size = new System.Drawing.Size(67, 23);
			this._txtCnclCnt.TabIndex = 6;
			this._txtCnclCnt.TabStop = false;
			this._txtCnclCnt.TextAlign = System.Windows.Forms.HorizontalAlignment.Right;
			this._txtCnclCnt.ValidationGroup = null;
			this._txtCnclCnt.WaterMarkColor = System.Drawing.Color.Empty;
			this._txtCnclCnt.WaterMarkText = "";
			// 
			// _txtCnclAmt
			// 
			...
			this._txtCnclAmt.Location = new System.Drawing.Point(273, 17);
			this._txtCnclAmt.Name = "_txtCnclAmt";
			this._txtCnclAmt.ReadOnly = true;
			this._txtCnclAmt.Size = new System.Drawing.Size(100, 23);
			this._txtCnclAmt.TabIndex = 5;
			...
			// _txtApprCnt
			// 
			this._txtApprCnt.DelegateProperty = true;
			this._txtApprCnt.Font = new System.Drawing.Font("Microsoft Sans Serif", 8.25F);
			this._txtApprCnt.Location = new System.Drawing.Point(149, 17);
			this._txtApprCnt.Name = "_txtApprCnt";
			this._txtApprCnt.ReadOnly = true;
			this._txtApprCnt.Size = new System.Drawing.Size(67, 23);
			this._txtApprCnt.TabIndex = 2;
			this._txtApprCnt.TabStop = false;
			this._txtApprCnt.TextAlign = System.Windows.Forms.HorizontalAlignment.Right;
			this._txtApprCnt.ValidationGroup = null;
			this._txtApprCnt.WaterMarkColor = System.Drawing.Color.Empty;
			this._txtApprCnt.WaterMarkText = "";
			// 
			// _txtApprAmt
			// 
			...
			this._txtApprAmt.Location = new System.Drawing.Point(48, 17);
			this._txtApprAmt.Name = "_txtApprAmt";
			this._txtApprAmt.ReadOnly = true;
			this._txtApprAmt.Size = new System.Drawing.Size(100, 23);
			this._txtApprAmt.TabIndex = 1;
			...
			this.Name = "WDR0600";
			this.Text = "출금원장조회:WDR0600";
			this.Load += new System.EventHandler(this.WDR0600_Load);
		...
		private BANANA.Windows.Controls.TextBox _txtApprCnt;
		private BANANA.Windows.Controls.TextBox _txtApprAmt;
		private BANANA.Windows.Controls.TextBox _txtTotalCnt;
		private BANANA.Windows.Controls.TextBox _txtTotalAmt;
		private BANANA.Windows.Controls.Label label10;
		private BANANA.Windows.Controls.Label label9;
		private BANANA.Windows.Controls.TextBox _txtCnclCnt;
