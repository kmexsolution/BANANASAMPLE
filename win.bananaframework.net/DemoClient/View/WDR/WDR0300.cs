...
namespace DemoClient.View.WDR
{
	...
	/// 설  명: 한도초과거래를 관리하는 화면입니다.
	/// </summary>
	public partial class WDR0300 : DemoClient.Controllers.BaseForm, Controllers.IBaseForm
	{
		// 검색 쓰레드
		private Thread _thread;
		DataTable _DataTable = null;

		#region WDR0300 : 생성자 함수
		/// <summary>
		/// 생성자 함수
		/// </summary>
		public WDR0300()
		...
		#region WDR0300_Load : 폼 로드 이벤트
		/// <summary>
		/// 폼 로드 이벤트
		/// </summary>
		/// <param name="sender"></param>
		/// <param name="e"></param>
		private void WDR0300_Load(object sender, EventArgs e)
		{
			try
			{
				...
				//_dtpTRADEDATE_S_S.Value		= Convert.ToDateTime("2014-07-25 12:36:00");
				//_dtpTRADEDATE_E_S.Value		= Convert.ToDateTime("2014-07-25 12:38:00");
		...
		int Search()
		{
			...
			try
			{
				...
				DataTable _dt			= base.GetDataTable("PCSP_WDR0300_R1"
		...
		#region _btnRelease_Click : 한도초과해제처리 버튼 클릭 이벤트
		/// <summary>
		/// 한도초과해제처리 버튼 클릭 이벤트
		/// </summary>
		/// <param name="sender"></param>
		/// <param name="e"></param>
		private void _btnRelease_Click(object sender, EventArgs e)
		{
			try
			{
				WDR0310 _form		= new WDR0310();
				...
				if (res == System.Windows.Forms.DialogResult.OK)
				{
					...
					foreach (DataGridViewRow row in checkedRows)
					{
						try
						{
							base.ExecuteNonQuery("PCSP_WDR0300_U1"
							...
							row.Cells["STATUS"].Value	= "한도초과해제완료";
					...
					MessageBox.Show("한도초과해제처리를 완료 하였습니다.");
				}
				else
				{
					MessageBox.Show("한도초과해제처리를 취소 하였습니다.");
				}
			}
			catch (Exception err)
			{
