...
namespace DemoClient.View.WDR
{
	...
	/// </summary>
	public partial class WDR0450 : DemoClient.Controllers.BaseForm, Controllers.IBaseForm
	{
		// 검색 쓰레드
		private Thread _thread;

		#region WDR0450 : 생성자 함수
		/// <summary>
		/// 생성자 함수
		/// </summary>
		public WDR0450()
		...
		#region WDR0450_Load : 폼 로드 이벤트
		/// <summary>
		/// 폼 로드 이벤트
		/// </summary>
		/// <param name="sender"></param>
		/// <param name="e"></param>
		private void WDR0450_Load(object sender, EventArgs e)
		{
			try
			{
		...
		int Search()
		{
			...
			try
			{
				...
				DataTable _dt			= base.GetDataTable("PCSP_WDR0450_R1"
			...
			try
			{
				...
				if (res == System.Windows.Forms.DialogResult.OK)
				{
					...
					foreach (DataGridViewRow row in checkedRows)
					{
						try
						{
							base.ExecuteNonQuery("PCSP_WDR0450_U1"
					...
					MessageBox.Show("출금요청처리를 완료 하였습니다.");
				}
				else
				{
					MessageBox.Show("출금요청처리를 취소 하였습니다.");
				}
			}
			catch (Exception err)
			{
